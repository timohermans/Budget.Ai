...
/// </summary>
public class TestModeAuthMiddleware(RequestDelegate next, ILogger<TestModeAuthMiddleware> logger)
{
    ...
    public async Task Invoke(HttpContext context)
    {
        ...
        if (!string.IsNullOrEmpty(testUser))
        {
            ...
            logger.LogDebug("Test-mode request authenticated as user {TestUser}", testUser);
        }
